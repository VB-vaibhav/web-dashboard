...
//   const [showAlert, setShowAlert] = useState(false);
//   const isMobile = useIsMobile();
//   const useResizableColumns = (columnCount) => {
//     const [columnWidths, setColumnWidths] = useState(() =>
//       Array(columnCount).fill(150)
//     );
...
//         newWidths[index] = Math.max(startWidth + delta, 50); // min width = 50px
...
//   };
//   const { columnWidths, startResizing } = useResizableColumns(8); // 8 columns
...
//                           minWidth: '50px',
//                         }}
//                         className={`relative px-4 py-3 font-semibold border-r group ${dark ? 'border-gray-700' : 'border-gray-300'} text-left whitespace-nowrap`}
//                       >
